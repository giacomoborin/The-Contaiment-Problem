...
\newcommand{\cont}[2]{ I^{(#1)} \subset I^{#2}}
...
\section{Symbolic Powers and saturation of ideals}
...
\chapter{The Containment Problem}
	...
	For a general ideal $ I $ we define the height of $ I $ as the minimum height of its prime ideals and the \textbf{big height of $ I $} as the maximal height of its associated primes. \\
	...
	\begin{tcolorbox}
		Nell'atricolo di Szemberg nel teorema 1.3 non richiede che I sia radicale, mi sono perso qualcosa? Mentre lo chiedono nell'articolo di Ein quando fa il discorso per la dimensione della varietà n= dim(X)\\
		Why associated?\\
